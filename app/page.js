...
export default function ProfileLogic1()
{
  ...
  return(
    <div className=" min-h-screen  bg-blue-200 justify-center flex items-center">
      ...
      <h1 className="text-center text-2xl font-bold mb-4"> Create Profile</h1>
      ...
      <button className="mt-6 bg-blue-600 hover:bg-blue-700 text-white p-2 rounded-lg w-full"
      onClick={()=>router.push("/edit")}>Create Profile</button>
      </div>
    </div>
  );
